...
public class EpicFightKeyMappings {
	...
	public static final KeyMapping SPECIAL_SKILL = new SpecialAttackKeyMapping("key." + EpicFightMod.MODID + ".weapon_special_skill", InputConstants.Type.KEYSYM, GLFW.GLFW_KEY_J, "key." + EpicFightMod.MODID + ".
